...
const THREBET_RANGES: Record<string, Record<string, string>> = {
  ...
  'SB_VS_BTN': {
    'AA':'R','KK':'R','QQ':'R','JJ':'R','TT':'R',
    'AKs':'R','AQs':'R','AJs':'R','ATs':'R','A9s':'R','A8s':'R','A7s':'R','A6s':'R','A5s':'R','A4s':'R','A3s':'R','A2s':'R',
    'KQs':'R','K9s':'R','K5s':'R','K4s':'R','K3s':'R','QJs':'R','Q9s':'R','JTs':'R','J8s':'R','J7s':'R','T9s':'R','98s':'R',
    'AKo':'R','AQo':'R','AJo':'R','KQo':'R',
    '99':'C','88':'C','77':'C','66':'C',
    'KJs':'C','KTs':'C','QTs':'C','87s':'C','76s':'C',
  },
  'SB_VS_CO': {
    'AA':'R','KK':'R','QQ':'R','JJ':'R',
    'AKs':'R','AQs':'R','AJs':'R','ATs':'R','A8s':'R','A7s':'R','A6s':'R','A5s':'R','A4s':'R',
  ...
  'SB_VS_EP': {
    'AA':'R','KK':'R','QQ':'R','JJ':'R',
    'AKs':'R','AQs':'R','AJs':'R','A7s':'R','A6s':'R','A5s':'R','KQs':'R',
    'AKo':'R','AQo':'R',
    'TT':'C','99':'C','88':'C',
    'ATs':'C','KJs':'C','QJs':'C',
    'AJo':'C','KQo':'C',
